module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                files: {
                    ...
                    'styles/editor.css': 'sass/editor.scss'
                }
            }
        },
        autoprefixer: {
        ...
        excludeFiles: '--exclude "*.gitignore" --exclude ".sass-cache/" --exclude "*.DS_Store" --exclude ".git/" --exclude ".idea/" --exclude "gruntfile.js" --exclude "node_modules/" --exclude "package.json" --exclude "sass/" --exclude "style.css.map" --exclude "styles/admin.css.map" --exclude "styles/customizer.css.map" --exclude "styles/editor.css.map"',
        shell: {
            zip: {
                command: [
