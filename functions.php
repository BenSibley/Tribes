...
function ct_tribes_register_required_plugins()
{
    $plugins = array(
    ...
    $config = array(
        ...
        'message'      => '',
        'strings'      => array(
            'page_title'                      => __('Install Recommended Plugins', 'tribes'),
            'menu_title'                      => __('Recommended Plugins', 'tribes'),
            'notice_can_install_recommended'     => _n_noop(
                'The makers of the Tribes theme now recommend installing Independent Analytics, their new plugin for visitor tracking: %1$s.',
                'The makers of the Tribes theme now recommend installing Independent Analytics, their new plugin for visitor tracking: %1$s.',
                'tribes'
            ),
        )
...
add_action('tgmpa_register', 'ct_tribes_register_required_plugins');
...
add_filter('comment_form_field_comment', 'ct_tribes_update_comment_field', 7);
...
if (! function_exists('ct_tribes_social_array')) {
    function ct_tribes_social_array()
    {
        $social_sites = array(
            ...
            'researchgate'  => 'tribes_researchgate_profile',
...
//----------------------------------------------------------------------------------
function ct_tribes_register_elementor_locations($elementor_theme_manager)
{
    $elementor_theme_manager->register_location('header');
    $elementor_theme_manager->register_location('footer');
}
add_action('elementor/theme/register_locations', 'ct_tribes_register_elementor_locations');
